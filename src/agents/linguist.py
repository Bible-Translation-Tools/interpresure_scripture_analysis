...
class LinguistAgent:
    ...
    def _construct_prompt(self, pragmatic_annotations, translation, greek_verse):
        prompt = (
            f"ROLE: You are performing a cross-lingual pragmatic analysis.\n"
            "---------------------------------------------------------------------------------\n"
            f"# GROUND TRUTH ANALYSIS:\n"
            f"Greek Verse: \"{greek_verse}\"\n"
            f"\"{pragmatic_annotations}\"\n"
            "# TASK:\n"
            f"Evaluate the following translation with respect to the pragmatic goal with your rationale being based on the expert annotations of the Greek.\n"
