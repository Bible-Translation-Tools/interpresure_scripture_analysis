...
class PragmaticAnalystReview(BaseModel):
    ...
    weaknesses: str = Field(..., description="A Markdown formatted list (in English) of things the translation does well with respect to the annotations.")
    suggestions: str = Field(..., description="A Markdown formatted (in English) list of things the translation does well with respect to the annotations.")
